...
function App() { return <div className="flex h-screen overflow-hidden bg-slate-50"><Sidebar /><div className="h-full min-w-0 flex-1 overflow-y-auto"><Suspense fallback={<LoadingSpinner />}><Routes><Route path="/" element={<Dashboard />} /><Route path="/departments" element={<Departments />} /><Route path="/assets" element={<AllAssets />} /><Route path="/inventory/assign" element={<AssignInventory />} /><Route path="/inventory/bundles" element={<WorkstationBundles />} /><Route path="/inventory/employees" element={<EmployeeAssignment />} /><Route path="/inventory/transfers" element={<AssetTransfers />} /><Route path="/inventory/repairs" element={<RepairsClearance />} /><Route path="/consumables" element={<Consumables />} /><Route path="/consumables/stock-usage" element={<StockUsage />} /><Route path="/consumables/low-stock" element={<LowStockConsumables />} /><Route path="/reports" element={<InventoryReports />} /><Route path="/settings" element={<Settings />} /><Route path="/profile" element={<Profile />} /><Route path="*" element={<Placeholder />} /></Routes></Suspense></div></div> }
